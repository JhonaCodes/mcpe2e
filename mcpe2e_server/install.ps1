...
Write-Host "    1. Tell your AI agent:"
Write-Host '         run_command command:"flutter run" working_dir:"C:\path\to\app" background:true'
Write-Host "    2. Wait ~15s, then:"
Write-Host "         list_devices       <- auto port-forwarding (finds a free port automatically)"
Write-Host "         select_device      <- if multiple devices"
Write-Host "         inspect_ui         <- start testing"
Write-Host ""
Write-Host "  Desktop (Windows)"
Write-Host "    1. Start app in debug mode."
Write-Host "       The app picks a free port automatically — check its output for the URL."
Write-Host "    2. Set TESTBRIDGE_URL=<url_from_app_output> in your agent config"
Write-Host "    3. Ask your AI agent: inspect_ui"
Write-Host "────────────────────────────────────────────────────────────────"
